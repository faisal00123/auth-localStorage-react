...
const Login = () => {
  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">Log In</h2>
...
<div className="flex items-start mb-5">
    <label for="remember-alternative" className="flex items-center h-5">
     ...
     <div className='flex justify-around items-center gap-2'>
           <button className="flex items-center justify-center gap-2 rounded-lg bg-blue-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-blue-300 transition duration-100 hover:bg-blue-600 focus-visible:ring active:bg-blue-700 md:text-base cursor-pointer">
